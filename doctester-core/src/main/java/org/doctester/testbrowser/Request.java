...
public class Request {
	...
	/**
	 * I am private. Please use GET(), POST() and so on to get an instance of this
	 * class.
	 */
	private Request() {
	...
	/**
	 *
	 * Add a file to be sent as multipart form post/put. Only makes sense for POST
	 * and PUT Http requests.
	 *
	...
	/**
	 *
	 * Add an arbitrary form parameter to this request. Only makes sense for POST
	 * or PUT requests.
	 *
	 * @param key The header key.
	 * @param value The header value.
